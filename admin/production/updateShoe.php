    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="form-group">
          ...
          <input required value="<?php echo $shoe['review']?>" minlength="1" maxlength="1000" name="review" type="text" class="form-control" id="exampleInputPassword1" placeholder="Nhập giới thiệu">
        </div>
        <div class="form-group">
